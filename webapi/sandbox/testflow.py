...
webServerAddress = "https://10.1.0.212"
apiVersion = "v1"
username = "jyan@dispersivegroup.com"
password = "D1spers1ve$#"
...
src_EndpointsList = ["10.50.1.11/172.31.0.28"]
dst_EndpointsList = ["10.50.1.12/172.31.0.17"]
...
try:
	...
	# Note: the statistic names should be identical to those that appear in the results CSV
	results = ixchariotApi.getFlowLevelResults(session, ["Throughput", "Total Datagrams Sent"], "FlowGroup 1", "TCP Baseline Performance", "TCP")
	...
	results = ixchariotApi.getUserLevelResultsFromFlow(session, ["Throughput"], "FlowGroup 1", "TCP Baseline Performance", "TCP", 1)
